menu = {
   ...
   [5] = { nome="Dango Balango", descricao = "As aventuras dos bonecos Sdruvs, Judoca, Druzila e seus amigos, que \nvivenciam situações inusitadas, lúdicas e, por vezes, absurdas."
   },
   [6] = { nome="Harmonia", descricao = "O programa traz reportagens, matérias e documentários com o objetivo \nde divulgar a música clássica de forma atraente."
   },
   [7]=  { nome="Hypershow", descricao ="Magazine musical que exibe reportagens e entrevistas com grandes \nnomes do universo da música brasileira e internacional, combinando \nconteúdo informativo, opinativo, making offs e depoimentos de artistas \ne críticos."
   },
   [8] = { nome="Imagem da Palavra", descricao = "A atração faz uma viagem pelo mundo dos livros e o universo que se \nabre a partir da palavra escrita, falada e cantada."
   },
